...
public final class SpecialComponentUtil {
    ...
    private static List<Claim.SupportingInformationComponent> getConditionsByCategory(
            List<Claim.SupportingInformationComponent> componentList, String category) {
