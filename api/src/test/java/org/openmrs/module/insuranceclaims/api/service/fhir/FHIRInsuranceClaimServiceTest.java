...
public class FHIRInsuranceClaimServiceTest extends BaseModuleContextSensitiveTest {
    ...
    public void setUp() throws Exception {
        ...
        insuranceClaimDiagnosisService.saveOrUpdate(insuranceClaimDiagnosis);

        InsuranceClaimItem insuranceClaimItem = createTestClaimItem();
        insuranceClaimItemService.saveOrUpdate(insuranceClaimItem);
    }
    ...
    public void generateFhirClaim_shouldMapInsuranceClaimToFhirClaim() throws FHIRException {
        ...
        Claim generatedClaim = fhirInsuranceClaimService.generateClaim(savedInsuranceClaim);
    ...
    public void generateOmrsClaim_shouldMapFhirClaimToOmrsClaim() throws FHIRException {
        ...
        Claim fhirClaim = fhirInsuranceClaimService.generateClaim(savedInsuranceClaim);
        List<String> errors = new ArrayList<>();
        InsuranceClaim generatedClaim = fhirInsuranceClaimService.generateOmrsClaim(fhirClaim, errors);
